...
Original file is located at
    https://colab.research.google.com/drive/13gPkY1gc8cv6fEwIPTa7PoePU6VzmqWR

# Setup

Setting up the Colab to make sure this notebook works well in both python 2 and 3, import a few common modules, ensure MatplotLib plots figures inline and prepare a function to save the figures:
"""
